(function(global){
  const CLASS_DATABASE = [
    { name:"Knight", category:"Combat", stats:{STR:8,DEX:4,CON:8,INT:3,WIS:4,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:35,EP:1,AP:2,MOV:3}, startingSkills:["Taunt","Shield Wall","Parry"] },
    { name:"Magician", category:"Combat", stats:{STR:3,DEX:5,CON:4,INT:8,WIS:6,CHA:4}, attunement:{FAE:6,DREAM:5}, resources:{HP:22,EP:1,AP:2,MOV:4}, startingSkills:["Arcane Bolt","Elemental Blast","Ward"] },
    { name:"Warlock", category:"Utility", stats:{STR:3,DEX:4,CON:4,INT:7,WIS:4,CHA:4}, attunement:{FAE:7,DREAM:7}, resources:{HP:20,EP:1,AP:2,MOV:4}, startingSkills:["Life Leech","Hex","Dark Pact"] },
    { name:"Archer", category:"Combat", stats:{STR:4,DEX:8,CON:5,INT:4,WIS:3,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:24,EP:1,AP:2,MOV:6}, startingSkills:["Snipe","Volley","Pinning Shot"] },
    { name:"Scout", category:"Utility", stats:{STR:4,DEX:7,CON:4,INT:4,WIS:3,CHA:6}, attunement:{FAE:0,DREAM:0}, resources:{HP:22,EP:1,AP:2,MOV:7}, startingSkills:["Slipstream Step","Trap Sense","Ambush"] },
    { name:"Cleric", category:"Support", stats:{STR:3,DEX:4,CON:5,INT:5,WIS:8,CHA:5}, attunement:{FAE:0,DREAM:2}, resources:{HP:26,EP:1,AP:2,MOV:4}, startingSkills:["Heal","Turn Undead","Ward Chant"] },
    { name:"Druid", category:"Support", stats:{STR:3,DEX:4,CON:5,INT:6,WIS:7,CHA:4}, attunement:{FAE:6,DREAM:3}, resources:{HP:25,EP:1,AP:2,MOV:5}, startingSkills:["Shapeshift","Entangle","Restorative Wind"] },
    { name:"Fighter", category:"Combat", stats:{STR:7,DEX:6,CON:6,INT:4,WIS:4,CHA:4}, attunement:{FAE:0,DREAM:0}, resources:{HP:30,EP:1,AP:2,MOV:5}, startingSkills:["Power Strike","Counter","Weapon Stance"] },
    { name:"Rogue", category:"Combat", stats:{STR:5,DEX:8,CON:4,INT:4,WIS:3,CHA:6}, attunement:{FAE:0,DREAM:0}, resources:{HP:22,EP:1,AP:2,MOV:6}, startingSkills:["Backstab","Poisoned Dagger","Camouflage"] },
    { name:"Monk", category:"Combat", stats:{STR:6,DEX:7,CON:5,INT:4,WIS:6,CHA:4}, attunement:{FAE:0,DREAM:2}, resources:{HP:27,EP:1,AP:2,MOV:6}, startingSkills:["Counterstrike","Chi Strike","Palm of Flame"] },
    { name:"Shaman", category:"Support", stats:{STR:4,DEX:4,CON:5,INT:5,WIS:7,CHA:4}, attunement:{FAE:2,DREAM:6}, resources:{HP:25,EP:1,AP:2,MOV:4}, startingSkills:["Totem Call","Spirit Bind","Stormsong"] },
    { name:"Warden", category:"Combat", stats:{STR:7,DEX:3,CON:9,INT:3,WIS:5,CHA:4}, attunement:{FAE:0,DREAM:0}, resources:{HP:38,EP:1,AP:2,MOV:3}, startingSkills:["Zone Control","Shield Slam","Fortify"] },
    { name:"Engineer", category:"Utility", stats:{STR:4,DEX:4,CON:6,INT:7,WIS:5,CHA:3}, attunement:{FAE:0,DREAM:0}, resources:{HP:28,EP:1,AP:2,MOV:4}, startingSkills:["Deploy Turret","Trap","Salvage Duty"] },
    { name:"Necromancer", category:"Utility", stats:{STR:3,DEX:4,CON:4,INT:8,WIS:4,CHA:3}, attunement:{FAE:0,DREAM:8}, resources:{HP:22,EP:1,AP:2,MOV:4}, startingSkills:["Raise Skeleton","Fear","Soul Drain"] },
    { name:"Reaper", category:"Combat", stats:{STR:6,DEX:7,CON:4,INT:5,WIS:4,CHA:3}, attunement:{FAE:0,DREAM:6}, resources:{HP:24,EP:1,AP:2,MOV:6}, startingSkills:["Shadow Strike","Harvest Soul","Fade Step"] },
    { name:"Symphonist", category:"Support", stats:{STR:4,DEX:5,CON:5,INT:6,WIS:5,CHA:8}, attunement:{FAE:4,DREAM:4}, resources:{HP:26,EP:1,AP:2,MOV:5}, startingSkills:["Harmony Strike","Discordant Wave","Resonance"] },
    { name:"Gunslinger", category:"Combat", stats:{STR:5,DEX:8,CON:4,INT:4,WIS:3,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:22,EP:1,AP:2,MOV:6}, startingSkills:["Trick Shot","Ricochet","Quickdraw"] },
    { name:"Ninja", category:"Combat", stats:{STR:5,DEX:9,CON:3,INT:4,WIS:3,CHA:4}, attunement:{FAE:4,DREAM:4}, resources:{HP:20,EP:1,AP:2,MOV:7}, startingSkills:["Smoke Vanish","Kunai Throw","Shadowstep"] },
    { name:"Samurai", category:"Combat", stats:{STR:7,DEX:6,CON:6,INT:4,WIS:6,CHA:4}, attunement:{FAE:0,DREAM:2}, resources:{HP:30,EP:1,AP:2,MOV:4}, startingSkills:["Iaido Strike","Discipline Stance","Resolve"] },
    { name:"Pirate", category:"Combat", stats:{STR:7,DEX:6,CON:5,INT:4,WIS:3,CHA:6}, attunement:{FAE:0,DREAM:0}, resources:{HP:28,EP:1,AP:2,MOV:5}, startingSkills:["Disarm","Broadside","Rally or Rum"] },
    { name:"Brigadier", category:"Support", stats:{STR:6,DEX:5,CON:8,INT:4,WIS:4,CHA:7}, attunement:{FAE:0,DREAM:0}, resources:{HP:34,EP:1,AP:2,MOV:4}, startingSkills:["Charge","Formation Guard","Tactical Rally"] },
    { name:"Privateer", category:"Combat", stats:{STR:6,DEX:7,CON:5,INT:4,WIS:4,CHA:6}, attunement:{FAE:0,DREAM:0}, resources:{HP:27,EP:1,AP:2,MOV:5}, startingSkills:["Boarding Action","Morale Breaker","Naval Tactics"] },
    { name:"Spellblade", category:"Combat", stats:{STR:6,DEX:6,CON:5,INT:7,WIS:4,CHA:4}, attunement:{FAE:5,DREAM:2}, resources:{HP:28,EP:1,AP:2,MOV:5}, startingSkills:["Flameblade","Arcane Slash","Elemental Guard"] },
    { name:"Skaldblade", category:"Support", stats:{STR:7,DEX:6,CON:6,INT:4,WIS:4,CHA:7}, attunement:{FAE:0,DREAM:0}, resources:{HP:30,EP:1,AP:2,MOV:5}, startingSkills:["Tempo Strike","Chant Rally","Momentum Slash"] },
    { name:"Essentier", category:"Utility", stats:{STR:5,DEX:5,CON:7,INT:7,WIS:4,CHA:3}, attunement:{FAE:0,DREAM:0}, resources:{HP:32,EP:1,AP:2,MOV:4}, startingSkills:["Alchemy Strike","Scrap Bomb","Essence Burn"] },
    { name:"Shadowguard", category:"Utility", stats:{STR:6,DEX:7,CON:6,INT:4,WIS:4,CHA:4}, attunement:{FAE:0,DREAM:3}, resources:{HP:30,EP:1,AP:2,MOV:5}, startingSkills:["Swap Places","Intercept","Silent Guard"] },
    { name:"Torchbearer", category:"Support", stats:{STR:7,DEX:5,CON:6,INT:4,WIS:4,CHA:4}, attunement:{FAE:6,DREAM:0}, resources:{HP:29,EP:1,AP:2,MOV:5}, startingSkills:["Ignite","Reveal Shadows","Firebrand"] },
    { name:"Swashbuckler", category:"Combat", stats:{STR:6,DEX:8,CON:5,INT:4,WIS:3,CHA:6}, attunement:{FAE:0,DREAM:0}, resources:{HP:28,EP:1,AP:2,MOV:6}, startingSkills:["Taunt","Parry-Riposte","Showboat"] },
    { name:"Riftwarden", category:"Utility", stats:{STR:5,DEX:5,CON:6,INT:6,WIS:7,CHA:4}, attunement:{FAE:0,DREAM:8}, resources:{HP:28,EP:1,AP:2,MOV:5}, startingSkills:["Teleport Rift","Banish","Anchor Zone"] },
    { name:"Bard", category:"Support", stats:{STR:3,DEX:4,CON:5,INT:5,WIS:5,CHA:9}, attunement:{FAE:0,DREAM:3}, resources:{HP:26,EP:1,AP:2,MOV:5}, startingSkills:["Inspiring Ballad","Cleansing Chorus","Battle Hymn"] },
    { name:"Dancer", category:"Support", stats:{STR:3,DEX:8,CON:4,INT:4,WIS:5,CHA:7}, attunement:{FAE:0,DREAM:2}, resources:{HP:22,EP:1,AP:2,MOV:7}, startingSkills:["Mirrorstep","Dodge Dance","Action Gift"] },
    { name:"Diplomat", category:"Support", stats:{STR:3,DEX:4,CON:4,INT:5,WIS:6,CHA:9}, attunement:{FAE:0,DREAM:2}, resources:{HP:22,EP:1,AP:2,MOV:5}, startingSkills:["Parley","Influence Morale","Truce"] },
    { name:"Commander", category:"Support", stats:{STR:5,DEX:5,CON:7,INT:4,WIS:5,CHA:8}, attunement:{FAE:0,DREAM:0}, resources:{HP:32,EP:1,AP:2,MOV:4}, startingSkills:["Command Authority","Deploy Orders","Rallying Cry"] },
    { name:"Quartermaster", category:"Support", stats:{STR:4,DEX:4,CON:6,INT:7,WIS:7,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:30,EP:1,AP:2,MOV:4}, startingSkills:["Supply Drop","Stamina Boost","Resupply"] },
    { name:"Librarian", category:"Utility", stats:{STR:3,DEX:4,CON:5,INT:9,WIS:6,CHA:4}, attunement:{FAE:0,DREAM:2}, resources:{HP:26,EP:1,AP:2,MOV:4}, startingSkills:["Reveal Weakness","Lore Archive","Battle Scan"] },
    { name:"Beastmaster", category:"Utility", stats:{STR:5,DEX:5,CON:6,INT:4,WIS:6,CHA:6}, attunement:{FAE:0,DREAM:0}, resources:{HP:30,EP:1,AP:2,MOV:5}, startingSkills:["Summon Beast","Command Beast","Wild Roar"] },
    { name:"Herbalist", category:"Support", stats:{STR:4,DEX:4,CON:5,INT:6,WIS:8,CHA:4}, attunement:{FAE:0,DREAM:0}, resources:{HP:26,EP:1,AP:2,MOV:5}, startingSkills:["Herbal Remedy","Poison Bomb","Antidote"] },
    { name:"Oracle", category:"Support", stats:{STR:3,DEX:4,CON:4,INT:6,WIS:9,CHA:5}, attunement:{FAE:2,DREAM:8}, resources:{HP:22,EP:1,AP:2,MOV:4}, startingSkills:["Prophecy","Veil Sight","Fate Bind"] },
    { name:"Chaplain", category:"Support", stats:{STR:4,DEX:4,CON:6,INT:5,WIS:8,CHA:6}, attunement:{FAE:0,DREAM:0}, resources:{HP:30,EP:1,AP:2,MOV:4}, startingSkills:["Sacred Ward","Blessing","Inspire Courage"] },
    { name:"Archivist", category:"Utility", stats:{STR:3,DEX:4,CON:5,INT:8,WIS:6,CHA:5}, attunement:{FAE:0,DREAM:2}, resources:{HP:26,EP:1,AP:2,MOV:4}, startingSkills:["Record Action","Shift Turn Order","Knowledge Recall"] },
    { name:"Soothsayer", category:"Utility", stats:{STR:3,DEX:4,CON:4,INT:6,WIS:8,CHA:5}, attunement:{FAE:0,DREAM:8}, resources:{HP:22,EP:1,AP:2,MOV:4}, startingSkills:["Omen","Redirect Curse","Hex Prolong"] },
    { name:"Caretaker", category:"Support", stats:{STR:4,DEX:4,CON:6,INT:5,WIS:8,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:30,EP:1,AP:2,MOV:4}, startingSkills:["Stabilize","Nurture","Revive"] },
    { name:"Chanter", category:"Support", stats:{STR:4,DEX:5,CON:5,INT:6,WIS:7,CHA:7}, attunement:{FAE:0,DREAM:2}, resources:{HP:26,EP:1,AP:2,MOV:5}, startingSkills:["Aura Chant","Sustained Hymn","Passive Blessing"] },
    { name:"Merchant", category:"Utility", stats:{STR:3,DEX:4,CON:5,INT:6,WIS:5,CHA:9}, attunement:{FAE:0,DREAM:0}, resources:{HP:26,EP:1,AP:2,MOV:5}, startingSkills:["Bargain","Market Manipulation","Greed is Good"] },
    { name:"Cartographer", category:"Utility", stats:{STR:3,DEX:5,CON:5,INT:7,WIS:7,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:27,EP:1,AP:2,MOV:5}, startingSkills:["Reveal Map","Alter Terrain","Pathfinder"] },
    { name:"Witch", category:"Utility", stats:{STR:3,DEX:5,CON:4,INT:6,WIS:5,CHA:5}, attunement:{FAE:8,DREAM:7}, resources:{HP:22,EP:1,AP:2,MOV:5}, startingSkills:["Hex","Illusion","Charm"] },
    { name:"Runesmith", category:"Support", stats:{STR:4,DEX:4,CON:5,INT:8,WIS:7,CHA:4}, attunement:{FAE:0,DREAM:0}, resources:{HP:26,EP:1,AP:2,MOV:4}, startingSkills:["Rune Ward","Explosive Glyph","Runic Enhancement"] },
    { name:"Tailor", category:"Utility", stats:{STR:3,DEX:7,CON:4,INT:6,WIS:5,CHA:6}, attunement:{FAE:6,DREAM:3}, resources:{HP:22,EP:1,AP:2,MOV:6}, startingSkills:["Illusion Stitch","Armor Weave","Disguise"] },
    { name:"Navigator", category:"Utility", stats:{STR:4,DEX:6,CON:5,INT:5,WIS:7,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:27,EP:1,AP:2,MOV:6}, startingSkills:["Pathfinder","Sea Legs","Sky Mark"] },
    { name:"Folk Companion", category:"Support", stats:{STR:4,DEX:5,CON:5,INT:4,WIS:4,CHA:4}, attunement:{FAE:0,DREAM:0}, resources:{HP:24,EP:1,AP:2,MOV:6}, startingSkills:["Trickster Fox","Owl Sight","Bear Roar"] },
    { name:"Artificer", category:"Utility", stats:{STR:4,DEX:5,CON:6,INT:8,WIS:5,CHA:4}, attunement:{FAE:0,DREAM:0}, resources:{HP:28,EP:1,AP:2,MOV:4}, startingSkills:["Gadget Deploy","Overclock","Repair"] },
    { name:"Chronicler", category:"Support", stats:{STR:3,DEX:4,CON:5,INT:6,WIS:6,CHA:7}, attunement:{FAE:0,DREAM:2}, resources:{HP:26,EP:1,AP:2,MOV:5}, startingSkills:["Record Heroics","Echo of Past","Tale Boost"] },
    { name:"Trapper", category:"Utility", stats:{STR:4,DEX:7,CON:5,INT:5,WIS:5,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:27,EP:1,AP:2,MOV:6}, startingSkills:["Snare","Pitfall","Net Toss"] },
    { name:"Tinker", category:"Utility", stats:{STR:3,DEX:6,CON:5,INT:7,WIS:5,CHA:5}, attunement:{FAE:0,DREAM:0}, resources:{HP:27,EP:1,AP:2,MOV:5}, startingSkills:["Build Ladder","Bridge","Quick Tool"] },
    { name:"Courier", category:"Utility", stats:{STR:3,DEX:7,CON:4,INT:5,WIS:5,CHA:7}, attunement:{FAE:0,DREAM:0}, resources:{HP:24,EP:1,AP:2,MOV:7}, startingSkills:["Swap Positions","Item Transfer","Messenger"] },
    { name:"Scrapper", category:"Utility", stats:{STR:6,DEX:5,CON:7,INT:4,WIS:4,CHA:4}, attunement:{FAE:0,DREAM:0}, resources:{HP:32,EP:1,AP:2,MOV:5}, startingSkills:["Scavenge","Improvised Weapon","Salvage Armor"] },
    { name:"Signalist", category:"Support", stats:{STR:3,DEX:5,CON:5,INT:6,WIS:5,CHA:8}, attunement:{FAE:0,DREAM:0}, resources:{HP:27,EP:1,AP:2,MOV:5}, startingSkills:["Flare","Flag Orders","Reveal Zone"] },
  ];
  ...
  const SKILL_BEHAVIORS = {
    ...
    "Slipstream Step":"moveSlipstream",
